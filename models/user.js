...
export const VALID_STRINGS = {
  ...
  /** @param {RegExp} HANDLE Username validation RegExp */
  HANDLE: /^[a-zA-Z0-9]*$/,
};
    ...
    username: {
      ...
      validate: [
        ...
        },
        {
          ...
          msg: `Username is less than ${VALID_SIZES.HANDLE.min} characters.`,
        },
        {
          validator: value => value.length <= VALID_SIZES.HANDLE.max,
          msg: `Username is more than ${VALID_SIZES.HANDLE.max} characters.`,
        },
      ],
    },
    password: String,
